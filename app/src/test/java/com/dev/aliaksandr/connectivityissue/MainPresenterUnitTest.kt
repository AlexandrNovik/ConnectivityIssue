...
class MainPresenterUnitTest {
    val testCounterSubject: PublishSubject<String> = PublishSubject.create<String>()
    val testConnectionSubject: PublishSubject<String> = PublishSubject.create<String>()
    private val view = object : MainContract.View {
        ...
        override fun updateConnectionText(value: String) {
            testConnectionSubject.onNext(value)
        }
    }
    ...
    fun connect_available() {
        ...
        val connectivityObservableTransformer = ConnectivityObservableTransformer()
        ...
        testCounterSubscriber.awaitValueCount(1, 1, TimeUnit.SECONDS)
